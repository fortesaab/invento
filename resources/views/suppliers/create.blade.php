    ...
    <x-slot name="header">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-semibold text-slate-800">Create Supplier</h2>
                    <p class="mt-1 text-sm text-slate-500">Add a new supplier for your inventory.</p>
                </div>
    ...
    <div class="bg-slate-50 py-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-5 px-8 py-6">
                    @csrf
